...
public interface GuacamoleTunnel {
    ...
    // @rjp extend tunnel to include required fields

    void setTunnelRequestTypeName(String tunnelRequestTypeName);

    String getTunnelRequestTypeName();

    void setConnectionConfiguration(GuacamoleConfiguration configuration);

    GuacamoleConfiguration getConnectionConfiguration();

    void setTunnelRequestInfo(GuacamoleClientInformation info);

    GuacamoleClientInformation getTunnelRequestInfo();
